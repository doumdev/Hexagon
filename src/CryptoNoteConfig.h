...
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_V2  = 80000; // increasing to allow bigger tx
...
const size_t   DIFFICULTY_LAG                                = 15;  // set to 15 to match hexagon_v2
...
const uint32_t HEXAGON_REWARD_ADJUSTMENT_BLOCK               = 1;
...
const char     CRYPTONOTE_NAME[]                             = "hexagon";
...
const int      P2P_DEFAULT_PORT                              =  8060;
const int      RPC_DEFAULT_PORT                              =  8061;
...
const char* const SEED_NODES[] = {"209.250.224.156:8060", "198.13.59.227:8060", "104.207.151.67:8060" };
...
} // Hexagon Constants & Configuration
